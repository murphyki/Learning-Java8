 ...
 */
package com.murphyki.learningjava8.executorservice;
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Logger.getLogger(Examples.class.getName()).log(Level.INFO, "oldRunnableWay just woke up!!");
    ...
    private void newRunnableWay() {
        ...
        Runnable r = () -> {
            try {
                ...
                Logger.getLogger(Examples.class.getName()).log(Level.INFO, "newRunnableWay just woke up!!");
            } catch (InterruptedException ex) {
                Logger.getLogger(Examples.class.getName()).log(Level.SEVERE, null, ex);
            }
        };
